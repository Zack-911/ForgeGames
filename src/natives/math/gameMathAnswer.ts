...
export default new NativeFunction({
  ...
  args: [
    ...
    { name: 'answer',    description: 'The numeric answer',     type: ArgType.Number,  required: true,  rest: false },
  ...
  execute(ctx, [guild, channel, answer, user]) {
    ...
    if (!session.data.question)      return this.customError('No question loaded. Use $gameNewMath first.')
