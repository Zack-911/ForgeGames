...
exports.default = new ForgeGamesEventManager_js_1.ForgeGamesEventHandler({
    name: 'gamesPlayerLeave',
    version: '1.0.0',
    description: 'Triggered on the gamesPlayerLeave event',
    listener(sessionId, guildId, channelId, userId) {
        const commands = this.getExtension(__1.ForgeGames, true).commands.get('gamesPlayerLeave');
...
//# sourceMappingURL=gamesPlayerLeave.js.map