...
exports.default = new ForgeGamesEventManager_js_1.ForgeGamesEventHandler({
    name: 'gamesSessionStart',
    version: '1.0.0',
    description: 'Triggered on the gamesSessionStart event',
    listener(sessionId, type, guildId, channelId) {
        const commands = this.getExtension(__1.ForgeGames, true).commands.get('gamesSessionStart');
...
//# sourceMappingURL=gamesSessionStart.js.map